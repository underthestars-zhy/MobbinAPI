...
final class MobbinAPITests: XCTestCase {
    ...
    func testLogin() async throws {
        ...
        let res = try await api.verify(code: "790680")
        print(api.token?.accessToken ?? "No Token")
        print(api.token?.refreshToken ?? "No Refresh Token")

        XCTAssertTrue(res)
    }

    func testRefresh() async throws {
        let api = MobbinAPI(email: "zhuhaoyu0909@icloud.com", token: Token(accessToken: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..KVvFSOddlMBusP9_BzAbfwuEt7O5o06tX4glI_LLM1I", refreshToken: "vr2WYWgBztAABdypZlAK1Q"))

        try await api.refreshToken()

        print(try api.retrieveToken())
    }
